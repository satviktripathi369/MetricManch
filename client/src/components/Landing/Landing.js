        ...
        <div className="landing__container">
            <div className="landing__header__container">
                <div className="landing__header">
                    ...
                    <Link to="/shop">
                        <Button variant='outlined' sx={[{ width: '190px', height: '50px', borderRadius: '20px', fontWeight: '700', backgroundColor: 'none', borderColor: 'white', color: 'white' }, { '&:hover': { backgroundColor: "white", color: "#9842F1", borderColor: 'white' } }]}>SHOP NOW</Button>
                    </Link>
                </div>
            </div>
